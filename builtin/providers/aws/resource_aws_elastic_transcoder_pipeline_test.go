...
resource "aws_s3_bucket" "content_bucket" {
  bucket = "aws_elasticencoder_pipeline_tf_content_bucket_"
  acl    = "private"
}

resource "aws_s3_bucket" "input_bucket" {
  bucket = "aws_elasticencoder_pipeline_tf_input_bucket_"
  acl    = "private"
}

resource "aws_s3_bucket" "thumb_bucket" {
  bucket = "aws_elasticencoder_pipeline_tf_thumb_bucket_"
  acl    = "private"
}
`
